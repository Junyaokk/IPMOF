...
class Task():
    def __init__(self, task_id,
        ...
        if (self.capacity_constr) & (self.capacity_type != 'both'):
    ...
    def run(self, scenario_num=None, data_dir=None):
        ...
        if self.instance.capmanager is None:
            ...
            self.instance.capmanager.invoke_CapConstr(self.input_fdc_capacity, 
                                                      ...
                                                      both_paras=self.both_paras)
            self.algorithm_sol_on_sku = self.instance.capmanager.opt_sol
        ...
        self.gen_task_info()
        self.write_to_csv(data_dir=task_dir)
